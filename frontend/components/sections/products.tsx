      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {products.map((p) => (
          <a
            ...
            className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg"
          >
            <div className="relative h-40 w-full overflow-hidden">
              ...
              />
              <span className="absolute left-3 top-3 rounded-full bg-background/85 px-2.5 py-1 font-mono text-[10.5px] text-muted-foreground backdrop-blur">
                {p.tag}
              </span>
            </div>
